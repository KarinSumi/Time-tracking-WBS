      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-slideUp" style={{ opacity: 0, animationDelay: '100ms', animationFillMode: 'forwards' }}>
        <div style={{
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-white/40 mt-1.5 text-sm font-medium">Start tracking your time with Aion</p>
          </div>

          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="register-name" className="text-[11px] font-semibold text-white/40 uppercase tracking-wider ml-1">Full Name</label>
            ...
            <div className="space-y-1.5">
              <label htmlFor="register-email" className="text-[11px] font-semibold text-white/40 uppercase tracking-wider ml-1">Email Address</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label htmlFor="register-org" className="text-[11px] font-semibold text-white/40 uppercase tracking-wider ml-1">
                Organization <span className="text-white/20 normal-case">(optional)</span>
              </label>
              <div className="relative">
                ...
                <input id="register-org" type="text" disabled={isLoading} className="glass-input w-full pl-11 pr-4 py-3 rounded-xl text-sm"
                  placeholder="Your company name" value={orgName} onChange={(e) => setOrgName(e.target.value)} />
              </div>
            </div>

            <div className="space-y-1.5">
              <label htmlFor="register-password" className="text-[11px] font-semibold text-white/40 uppercase tracking-wider ml-1">Password</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label htmlFor="register-confirm" className="text-[11px] font-semibold text-white/40 uppercase tracking-wider ml-1">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-white/30" />
                <input id="register-confirm" type={showPassword ? 'text' : 'password'} disabled={isLoading}
                  className="glass-input w-full pl-11 pr-4 py-3 rounded-xl text-sm" placeholder="Re-enter password"
            ...
            <div className="pt-1">
              <label className="flex items-start gap-2.5 text-xs text-white/35 cursor-pointer hover:text-white/50 transition-colors">
                ...
                <span className="leading-relaxed">
                  I agree to the <a href="#" className="text-blue-400/70 hover:text-blue-400">Terms of Service</a> and <a href="#" className="text-blue-400/70 hover:text-blue-400">Privacy Policy</a>
                </span>
              </label>
            </div>
          ...
          <div className="mt-7 text-center">
            ...
            <Link to="/login" className="text-xs text-blue-400/80 hover:text-blue-400 transition-colors font-medium">Sign in</Link>
          </div>
        </div>
      </div>
    </div>
