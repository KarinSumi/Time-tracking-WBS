    ...
    <div className="px-8 py-6 animate-slideUp opacity-0" style={{ animationFillMode: 'forwards' }}>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-[10px] text-[var(--text-faint)] mt-1 uppercase tracking-[0.2em] font-black">Preferences & Organization Control</p>
        </div>
      ...
      <div className="max-w-4xl space-y-6">
        ...
        <div className="glass-card p-7">
          ...
          <div className="space-y-6">
            <div>
              <label className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-wider ml-1 mb-2 block">Full Name</label>
            ...
            <div>
              <label className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-wider ml-1 mb-2 block">Email Address</label>
              <div className="relative">
            ...
            <div>
              <label className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-wider ml-1 mb-2 block">Organization</label>
              <div className="relative">
          ...
          <div className="space-y-5">
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-4">
                ...
                <div><p className="text-sm text-[var(--text-primary)] font-bold">Dark Appearance</p>
                  <p className="text-[10px] text-[var(--text-faint)] font-bold uppercase tracking-widest">Switch between light and dark themes</p></div>
              </div>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-4">
                ...
                <div><p className="text-sm text-[var(--text-primary)] font-bold">Notifications</p>
                  <p className="text-[10px] text-[var(--text-faint)] font-bold uppercase tracking-widest">Receive reminders and updates</p></div>
              </div>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-4">
                ...
                <div><p className="text-sm text-[var(--text-primary)] font-bold">Daily Target</p>
                  <p className="text-[10px] text-[var(--text-faint)] font-bold uppercase tracking-widest">Hours you aim to work per day</p></div>
              </div>
          ...
          <div className="space-y-6">
            <div className="glass-card p-7">
              <h2 className="text-[11px] font-semibold text-white/35 uppercase tracking-widest mb-6 flex items-center gap-2">
                <Building2 size={13} className="text-white/25" />Organization Branding</h2>
              
              <div className="flex flex-col md:flex-row gap-10 items-start">
                <div className="space-y-4">
                  <label className="text-[11px] font-semibold text-white/40 uppercase tracking-wider block">Brand Primary Color</label>
                  <div className="flex items-center gap-4">
                    <input 
                      type="color" 
                      value={brandColor} 
                  ...
                  <p className="text-[10px] text-white/20 leading-relaxed max-w-[200px]">
                    This color will be applied to buttons, active states, and accents across the platform.
                  </p>
                </div>

                <div className="flex-1 space-y-4">
                  <label className="text-[11px] font-semibold text-white/40 uppercase tracking-wider block">Organization Logo</label>
                  <div className="flex items-center gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-[9px] text-white/20 uppercase tracking-widest font-bold">Recommended: Square SVG or PNG (256x256)</p>
            ...
            <div className="glass-card p-7">
               <h2 className="text-[11px] font-semibold text-white/35 uppercase tracking-widest mb-5 flex items-center gap-2">
                <Globe size={13} className="text-white/25" />General Settings</h2>
              <div className="space-y-4">
                 <div>
                  <label className="text-[11px] font-semibold text-white/40 uppercase tracking-wider ml-1 mb-1.5 block">Organization Name</label>
                  <div className="relative">
